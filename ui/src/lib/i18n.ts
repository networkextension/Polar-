...
const en: Record<string, string> = {
  ...
  "video.retry": "Retry",
  "video.render": "Render final",
  "video.rendering": "Rendering...",
  "video.notRendered": "Not rendered yet — submit at least one shot, then click Render final.",
...
const zhCN: Record<string, string> = {
  ...
  "video.retry": "重试",
  "video.render": "合成最终视频",
  "video.rendering": "正在合成…",
  "video.notRendered": "尚未合成 — 至少完成一个镜头，再点击合成。",
  "video.notReady": "等待生成",
  "video.download": "下载",
