...
const en: Record<string, string> = {
  ...
  "editor.previewBadge": "Preview",
  "editor.previewToggle": "Preview",
  "editor.assistToggle": "AI Polish",
  "editor.assistTitle": "Bot polish",
  "editor.assistBot": "Bot",
  "editor.assistLLM": "Model (optional)",
  "editor.assistInstruction": "Instruction (optional)",
  "editor.assistInstructionPlaceholder": "Optional: describe what you want, e.g. \"more concise, keep the original viewpoint\".",
  "editor.assistRun": "Polish",
  "editor.assistApply": "Apply",
  "editor.assistDiff": "Diff",
  "editor.assistResult": "Polished result",
  "editor.assistNoResult": "No polished result yet",
  "editor.assistNoDiff": "No diff yet",
  ...
  "video.newProject": "New project",
  "video.untitled": "Untitled video",
  "video.noProjects": "No projects yet",
  "video.selectProject": "Select a project on the left or create a new one",
  "video.shots": "Shots",
  "video.addShot": "Add shot",
  "video.bulkImport": "Bulk import",
  "video.bulkImportHint": "Paste your full script — one shot per paragraph, separated by blank lines. Each paragraph becomes a new shot in order.",
  "video.bulkImportPlaceholder": "Shot 1 prompt...\n\nShot 2 prompt...\n\nShot 3 prompt...",
  "video.bulkImportConfirm": "Import shots",
  "video.bulkImportPreview": "{{count}} shots will be created",
  "video.bulkImportPartial": "Imported {{ok}} of {{total}} shots ({{fail}} failed)",
  "video.noShots": "No shots yet",
  "video.submit": "Submit",
  "video.submitAll": "Submit all",
  "video.retry": "Retry",
  "video.render": "Generate preview",
  "video.rendering": "Generating preview...",
  "video.notRendered": "No preview yet — submit at least one shot, then click Generate preview. (Final-quality editing belongs in CapCut.)",
  "video.notReady": "Not ready yet",
  "video.download": "Download",
  "video.followProjectDefault": "Follow project default",
  "video.audio": "Audio",
  "video.bgm": "Background music",
  "video.voiceover": "Voiceover",
  "video.uploadAudio": "Upload",
  "video.record": "Record",
  "video.stopRecord": "Stop",
  "video.useThisRecording": "Upload this recording",
  "video.discardRecording": "Discard",
  "video.noBgm": "No background music yet",
  "video.noVoiceover": "No voiceover yet",
  "video.volume": "Volume",
  "video.finalVideo": "Preview",
  "video.previewHint": "This is a quick preview from the raw shots. Download the shots and edit in CapCut for the final cut.",
  "video.downloadAllShots": "Download all shots",
  "video.duplicate": "Duplicate",
  "video.regenerate": "Regenerate",
  "video.confirmRegenerate": "Regenerating will replace the current video. Continue?",
  "video.useThisFrame": "📸 Use this frame",
  "video.useThisFrameHint": "Pause the video at the desired frame, then click to capture.",
  "video.characterReferences": "Character references",
  "video.characterReferenceHint": "Latest one is sent as the first frame on every new submission.",
  "video.confirmDeleteProject": "Delete this project? This cannot be undone.",
  "video.confirmDeleteShot": "Delete this shot?",
  "video.confirmDeleteAsset": "Delete this audio?",
  "video.promptNewProjectTitle": "Project title",
  "video.status.draft": "Draft",
  "video.status.rendering": "Rendering",
  "video.status.rendered": "Rendered",
  "video.status.failed": "Failed",
  "video.status.pending": "Pending",
  "video.status.queued": "Queued",
  "video.status.running": "Running",
  "video.status.succeeded": "Succeeded",
  "creation.title": "Creation",
  "creation.newEntry": "New story",
  "creation.editEntry": "Editing story",
  "creation.loadFailed": "Failed to load story",
  "creation.save": "Save",
  "creation.saved": "Saved",
  "creation.saveFailed": "Save failed",
  "creation.titleContentRequired": "Title and content are required",
  "creation.titlePlaceholder": "Title your story",
  "creation.makePublic": "Make public",
  "creation.makePrivate": "Make private",
  "creation.backToDashboard": "Dashboard",
  "creation.assistInstructionPlaceholder": "Optional: how should I polish this?",
  "creation.assistNoBot": "No bot available",
  "creation.assistDefaultLLM": "Follow bot default",
  "creation.assistBotRequired": "Please select a bot first",
  "creation.assistRun": "Polish selection",
  "creation.assistClose": "Close",
  "creation.assistApply": "Replace selection",
  "creation.assistDiscard": "Discard",
  "creation.assistRunning": "Polishing selection...",
  "creation.assistFailed": "Failed to polish",
  "creation.assistReady": "Polish ready",
  "creation.presetTighter": "Tighter",
  "creation.presetFormal": "More formal",
  "creation.presetFriendly": "Friendlier",
  "creation.presetExpand": "Expand",
...
const zhCN: Record<string, string> = {
  ...
  "editor.previewBadge": "预览",
  "editor.previewToggle": "预览",
  "editor.assistToggle": "AI 润色",
  "editor.assistTitle": "Bot 润色助手",
  "editor.assistBot": "Bot",
  "editor.assistLLM": "模型（可选）",
  "editor.assistInstruction": "润色要求（可选）",
  "editor.assistInstructionPlaceholder": "可选：写本次润色要求，例如\"更专业、更简洁、保留原观点\"",
  "editor.assistRun": "润色正文",
  "editor.assistApply": "应用到正文",
  "editor.assistDiff": "查看差异",
  "editor.assistResult": "润色结果",
  "editor.assistNoResult": "暂无润色结果",
  "editor.assistNoDiff": "暂无差异",
  ...
  "dashboard.llmConfigBadge": "LLM 配置",
  "dashboard.botUserBadge": "Bot 用户",
  ...
  "video.title": "视频工作室",
  "video.projects": "项目",
  "video.newProject": "新建项目",
  "video.untitled": "未命名视频",
  "video.noProjects": "暂无项目",
  "video.selectProject": "请在左侧选择一个项目，或新建一个",
  "video.shots": "镜头",
  "video.addShot": "添加镜头",
  "video.bulkImport": "批量导入",
  "video.bulkImportHint": "把整段脚本贴进来 — 一段一个镜头，段落之间用空行分隔，会按顺序生成镜头。",
  "video.bulkImportPlaceholder": "镜头 1 的 prompt...\n\n镜头 2 的 prompt...\n\n镜头 3 的 prompt...",
  "video.bulkImportConfirm": "导入镜头",
  "video.bulkImportPreview": "将创建 {{count}} 个镜头",
  "video.bulkImportPartial": "已导入 {{ok}} / {{total}} 个镜头（{{fail}} 个失败）",
  "video.noShots": "暂无镜头",
  "video.submit": "提交",
  "video.submitAll": "全部提交",
  "video.retry": "重试",
  "video.render": "生成 Preview",
  "video.rendering": "正在生成 Preview…",
  "video.notRendered": "尚无预览 — 至少完成一个镜头，再点 生成 Preview。最终剪辑请下载到 CapCut 等工具。",
  "video.notReady": "等待生成",
  "video.download": "下载",
  "video.followProjectDefault": "跟随项目默认",
  "video.audio": "音频",
  "video.bgm": "背景音乐",
  "video.voiceover": "配音",
  "video.uploadAudio": "上传",
  "video.record": "录音",
  "video.stopRecord": "停止",
  "video.useThisRecording": "上传该录音",
  "video.discardRecording": "丢弃",
  "video.noBgm": "暂无背景音乐",
  "video.noVoiceover": "暂无配音",
  "video.volume": "音量",
  "video.finalVideo": "Preview 预览",
  "video.previewHint": "这是从原始镜头快速合成的预览，最终剪辑请下载镜头到 CapCut 等工具完成。",
  "video.downloadAllShots": "下载全部镜头",
  "video.duplicate": "复制",
  "video.regenerate": "重新生成",
  "video.confirmRegenerate": "重新生成会替换当前视频，继续吗？",
  "video.useThisFrame": "📸 用这一帧",
  "video.useThisFrameHint": "把视频暂停到合适的一帧，再点这个按钮抽帧。",
  "video.characterReferences": "人物参考",
  "video.characterReferenceHint": "最新一张会作为后续提交的首帧。",
  "video.confirmDeleteProject": "确认删除该项目？此操作不可恢复。",
  "video.confirmDeleteShot": "确认删除该镜头？",
  "video.confirmDeleteAsset": "确认删除该音频？",
  "video.promptNewProjectTitle": "项目标题",
  "video.status.draft": "草稿",
  "video.status.rendering": "合成中",
  "video.status.rendered": "已合成",
  "video.status.failed": "失败",
  "video.status.pending": "待提交",
  "video.status.queued": "队列中",
  "video.status.running": "生成中",
  "video.status.succeeded": "已完成",
  "creation.title": "创作",
  "creation.newEntry": "新建文章",
  "creation.editEntry": "正在编辑",
  "creation.loadFailed": "加载文章失败",
  "creation.save": "保存",
  "creation.saved": "已保存",
  "creation.saveFailed": "保存失败",
  "creation.titleContentRequired": "标题和正文都需要填写",
  "creation.titlePlaceholder": "给这篇文章起个标题",
  "creation.makePublic": "设为公开",
  "creation.makePrivate": "设为私密",
  "creation.backToDashboard": "返回 Dashboard",
  "creation.assistInstructionPlaceholder": "可选：写一句润色要求",
  "creation.assistNoBot": "暂无可用 Bot",
  "creation.assistDefaultLLM": "跟随 Bot 默认配置",
  "creation.assistBotRequired": "请先选择一个 Bot",
  "creation.assistRun": "润色选中段",
  "creation.assistClose": "关闭",
  "creation.assistApply": "替换选中段",
  "creation.assistDiscard": "放弃结果",
  "creation.assistRunning": "正在润色选中段...",
  "creation.assistFailed": "润色失败",
  "creation.assistReady": "润色完成",
  "creation.presetTighter": "更精简",
  "creation.presetFormal": "更正式",
  "creation.presetFriendly": "更亲切",
  "creation.presetExpand": "展开补充",
  "bots.title": "Bot 管理",
